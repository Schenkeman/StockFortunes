...
struct NetworkManager {
    ...
    func getStockQuotes(symbols: [String], completion: @escaping (_ quote: [QuoteDataModel]?,_ error: String?)->()){
            ...
            if let response = response as? HTTPURLResponse {
                ...
                case .success:
                    ...
                    do {
                        ...
                        print(jsonData)
                        let apiResponse = try JSONDecoder().decode([QuoteDataModel].self, from: responseData)
