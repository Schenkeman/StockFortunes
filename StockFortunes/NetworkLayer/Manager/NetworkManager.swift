...
enum ServiceApiKey: String {
    case rapidAPI = "a871f038bamsh2d6d42255964483p1279e4jsnd354ca9dbaaf"
...
//    let rapidRouter = Router<RapidAPI>()
//    
//    func fetchQuotes(symbols: [String], completion: @escaping (_ stockModels: [StockModel]?, _ error: String?)->()){
//        
